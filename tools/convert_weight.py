...
if __name__ == '__main__':
    model_path = "model/jd/jd.h5"  # keras yolov3 h5 model file
    # model_path = "model/output/yolo_20210321T1553/ep042-loss13.549-val_loss9.856.h5"
    model_path = "model/output/yolo_20210321T1553_trained_weights_final.h5"
    # keras yolov3 h5 model file
    config_path = 'model/jd/jd.cfg'  # .cfg  file path
    weight_file = open('model/jd/new_jd.weights', 'wb')  # save darknet yolov3 weights file path
